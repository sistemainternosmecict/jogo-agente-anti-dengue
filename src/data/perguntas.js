const perguntas = [
      ...
      { pergunta: "Como evitar focos do mosquito?", opcoes: ["Tampar caixas d'água", "Deixar recipientes abertos", "Não limpar calhas"], corretas: [0] },
      { pergunta: "O mosquito da dengue pica mais em que horário?", opcoes: ["Meia-noite", "Durante o dia", "Ao amanhecer e entardecer"], corretas: [2] },
      { pergunta: "O que fazer com garrafas vazias?", opcoes: ["Virar com a boca para baixo", "Deixar ao ar livre", "Encher de água"], corretas: [0] },
      { pergunta: "Como lidar com pratinhos de plantas?", opcoes: ["Encher com água", "Retirar ou colocar areia", "Lavar diariamente"], corretas: [1] },
      { pergunta: "É importante limpar a calha?", opcoes: ["Sim", "Não", "Só no verão"], corretas: [0] },
      { pergunta: "Denunciar focos é uma atitude...", opcoes: ["Inútil", "Importante", "Chata"], corretas: [1] },
      { pergunta: "Quem deve combater a dengue?", opcoes: ["A prefeitura", "Todos nós", "Os vizinhos"], corretas: [1] },
      { pergunta: "Piscinas devem ser...", opcoes: ["Deixadas com água limpa parada", "Tratadas com cloro", "Esvaziadas sempre"], corretas: [1] },
      { pergunta: "É seguro reutilizar pneus como vasos?", opcoes: ["Sim, se tiver furos", "Não", "Só em área coberta"], corretas: [0] },
      { pergunta: "Qual melhor forma de informar a comunidade?", opcoes: ["Gritando na rua", "Campanhas educativas", "Escrevendo no muro"], corretas: [1] },
      ...
      { pergunta: "Vacina contra dengue existe?", opcoes: ["Sim, para alguns casos", "Não", "É proibida"], corretas: [0] }
    ];
